...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:/isNmCUF2x3Sh8RAp/4mh4ZGkcFAX/hLrzrK3AvpRzk=",
        version = "v1.12.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:noKVm2SsG4v0Yd0lHNtFYc9EUxIVvrr4kJ6hM8wvIYU=",
        version = "v0.0.0-20241022234722-4d5d5faf59fb",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Kcq5W2bA2PBcVtF0MqkQjpvCpwJr+pd7zxcQh2csg7E=",
        version = "v1.5.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:zPeXHM+WhMl2zSx76Rg3EE0jwXdkut9s45K+pwhcO1c=",
        version = "v0.18.0",
    )
    go_repository(
        name = "com_github_samber_slog_zerolog_v2",
        importpath = "github.com/samber/slog-zerolog/v2",
        sum = "h1:z2Flxz1igvyKDLqv4QjZSC6kEyB02emXL7u49R7Jxx0=",
        version = "v2.7.2",
    )
    go_repository(
